...
let newArr = formalGreeting(formalNames)
// console.log(newArr)
...
function identifier(jobsArray) {
    let filterJobsArray = jobsArray.filter((jobObj) => {
        return jobObj.programmer
    })
    return filterJobsArray[0]
}
